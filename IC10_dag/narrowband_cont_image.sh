#!/bin/bash
#
# narrowband_cont_image.sh
# execution script for generating a narrowband continuum image of LGLBS source
...
mv ${output_name}".tar" /projects/vla-processing/images/${src_name}/Absorption